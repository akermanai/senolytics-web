  ...
  return (
    <section className="bg-[#03032e] pt-32 pb-24 min-h-screen">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white leading-tight mb-3">Privacy Policy</h1>
        ...
        <div className="space-y-10 text-[#8b8fa8] leading-relaxed">
          ...
          <div>
            ...
            <p>
              Senolytics.ai is a brand of <strong className="text-white">Bontida Limited</strong>,
              a company registered in Cyprus (Registration Number: HE431123), with its registered
              office at Zinonos Kitieos 9, Egkomi 2406, Nicosia, Cyprus.
            </p>
            <p className="mt-3">
              For the purposes of the GDPR and applicable data protection legislation, Bontida
              Limited is the data controller for personal data collected through this website and
              our services.
            </p>
            <p className="mt-3">
              Contact:{" "}
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li>
                ...
                company name, phone number, provided when you complete our contact form or
                subscribe to communications.
              </li>
              <li>
                <strong className="text-white">Usage data</strong> — IP address, browser type,
                pages visited, time on site, referral source, collected automatically via cookies
                and analytics tools.
              </li>
              <li>
                <strong className="text-white">API usage data</strong> — if you use our LeadShield
                or other API products, we log query metadata (timestamps, query volumes, response
                codes) for billing, security and service improvement purposes.
              </li>
              <li>
                <strong className="text-white">Communications</strong> — the content of emails or
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              ...
              <li>To send product updates, newsletters or marketing communications where you have
                consented or where we have a legitimate interest to do so.</li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li>
                <strong className="text-white">Contract</strong> — where processing is necessary
                to provide services you have requested.
              </li>
              <li>
                <strong className="text-white">Legitimate interests</strong> — for improving our
                services, marketing to existing customers, and fraud prevention.
              </li>
              <li>
                <strong className="text-white">Consent</strong> — where you have explicitly
                agreed, e.g. to receive marketing emails or to accept cookies.
              </li>
              <li>
                <strong className="text-white">Legal obligation</strong> — where we must process
          ...
          <div>
            ...
            <p>
              ...
              this policy, or as required by law. Contact form submissions are retained for up to
              3 years. API usage logs are retained for up to 2 years. You may request deletion at
          ...
          <div>
            ...
            <p>
              Our data is hosted in SOC 2 Type II and ISO 27001 certified data centres in
              Falkenstein, Germany, operated 100% by renewable energy. Data of EU and UK customers
              does not leave the EU. We employ appropriate technical and organisational measures to
              protect your data against unauthorised access, loss, or disclosure.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              who assist in operating our website and services (such as hosting, analytics and
              email delivery), under strict data processing agreements. We may disclose data to
          ...
          <div>
            ...
            <p>
              We use cookies and similar tracking technologies to improve your experience. Please
              see our{" "}
              <a href="/cookie-policy" className="text-[#027fff] hover:underline">
                Cookie Policy
              </a>{" "}
              for full details.
            </p>
