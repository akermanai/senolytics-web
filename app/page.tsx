...
export const metadata = {
  ...
  description:
    "AI-based products to help businesses boost conversion rates, reduce customer acquisition costs and prevent fraud.",
};
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <h1 className="heading-xl mb-6">
                Turn Data Into<br />
                <span className="text-[#027fff]">Conversion Power</span>
              </h1>
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="absolute inset-0 bg-[#027fff]/20 blur-3xl rounded-full scale-75" />
                <Image
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <p className="body-lg">
                ...
                and obtain a winning competitive position — especially in highly regulated
                niches.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-14">
            ...
            <p className="body-lg max-w-2xl">
              Senolytics.ai develops three main AI products: real-time lead validation,
              funnel optimisation, and a proprietary model-training lab for enterprise.
            </p>
          </div>
            ...
            {[
              {
                title: "Lead Shield",
                tag: "Live",
                desc: "Validate mobile phones, emails and IPs in real time. Protect your business from lead fraud with 97%+ accuracy.",
                href: "/lead-shield",
              },
              {
                title: "Funnel Optimization",
                tag: "Beta",
                desc: "AI-powered funnel intelligence that identifies drop-off points and increases conversion across every acquisition step.",
                href: "/funnel-optimization",
              },
              {
                title: "AI Innovation Lab",
                tag: "Closed Beta",
                desc: "Train proprietary models on your own data. Rapid prototyping methodology. Currently open for financial services.",
              ...
              <div key={p.title} className="card-glow flex flex-col">
                ...
                <Link
                  href={p.href}
                  className="text-[#027fff] font-semibold text-sm hover:text-[#0a8fff] transition-colors"
                >
                  Learn more →
                </Link>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <p className="body-lg mb-6">
                ...
                <span className="text-[#027fff] font-semibold">Conversion Intelligence</span>{" "}
