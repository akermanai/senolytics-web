          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={p.title} className="card-glow flex flex-col">
                ...
                <Link href={p.href} className="text-[#027fff] font-semibold text-sm hover:text-[#0a8fff] transition-colors">
                  Learn more →
                </Link>
              </div>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div className="flex justify-center order-2 md:order-1">
              <div className="relative">
                <div className="absolute inset-0 bg-[#027fff]/10 blur-3xl rounded-full scale-75" />
                <Image
