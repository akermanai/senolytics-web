      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-10 text-[#8b8fa8] leading-relaxed">
          ...
          <div>
            ...
            <p className="mt-3">For more information on managing cookies, visit <a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#027fff] hover:underline">allaboutcookies.org</a>.</p>
          </div>
          ...
          <div>
            ...
            <p>If you have any questions about our use of cookies, please contact us at <a href="mailto:team@senolytics.ai" className="text-[#027fff] hover:underline">team@senolytics.ai</a>.</p>
          </div>
