      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-10 text-[#9ca3b8] leading-relaxed">
          <div>
            ...
            <p className="mt-3">For the purposes of the GDPR and applicable data protection legislation, Bontida Limited is the data controller for personal data collected through this website and our services.</p>
            <p className="mt-3">Contact: <a href="mailto:team@senolytics.ai" className="text-[#f59e0b] hover:underline">team@senolytics.ai</a></p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              ...
              <li>To send product updates, newsletters or marketing communications where you have consented or where we have a legitimate interest to do so.</li>
          ...
          <div>
            ...
            <p className="mt-4">To exercise any of these rights, contact us at <a href="mailto:team@senolytics.ai" className="text-[#f59e0b] hover:underline">team@senolytics.ai</a>. We will respond within 30 days.</p>
          </div>
          <div>
            <h2 className="text-white font-bold text-xl mb-4">9. Cookies</h2>
            <p>We use cookies and similar tracking technologies to improve your experience. Please see our <a href="/cookie-policy" className="text-[#f59e0b] hover:underline">Cookie Policy</a> for full details.</p>
          </div>
          <div>
